...
public class Hotesse {
    ...
    public Hotesse(int idHotesse, String nom, String prenom, String numero_Adr, String rue_adr, String codeP_adr, String ville, String pays, int nbHeures) {
    ...
    public int getIdHotesse() {
        return idHotesse;
    }

    public void setIdHotesse(int idHotesse) {
        this.idHotesse = idHotesse;
    }
